let express,jwt,bcrypt,config,validateLoginInput;_8eb‍.x([["default",()=>_8eb‍.o]]);_8eb‍.w("express",[["default",["express"],function(v){express=v}]]);_8eb‍.w("jsonwebtoken",[["default",["jwt"],function(v){jwt=v}]]);_8eb‍.w("bcrypt",[["default",["bcrypt"],function(v){bcrypt=v}]]);_8eb‍.w("../config/config",[["default",["config"],function(v){config=v}]]);_8eb‍.w("../validation/login",[["default",["validateLoginInput"],function(v){validateLoginInput=v}]]);
...
function volunteerSignUp (req, res) {
    ...
    User.find({
        ...
        newVolunteer.MDCPS_ID = MDCPS_ID;j
